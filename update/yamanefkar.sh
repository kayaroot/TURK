...
cd $HOME
rm -rf TURK/
git clone https://github.com/yamanefkar/TURK
termux-notification -t "Tool kullanıma hazır"
;;
...
clear
cd $HOME/ &&
cd TURK/bruteforce/ && bash tst.sh
...
"--04")
                ...
                cd $HOME/TURK/dos-ddos/ && python3 tst.py -s $dos_ip -p $dos_port -t $hiz
...
clear
cd $HOME/ &&
cd TURK/termux-api/ && bash tst.sh
